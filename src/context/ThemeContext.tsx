...
export const COLOR_THEMES: Record<ColorTheme, {
  ...
  navy: {
    ...
    colors: {
      ...
      text: '#F5F1EA',
      textMuted: 'rgba(245, 241, 234, 0.7)',
      accent: '#C9A75A',
      accentHover: '#DABB6A',
  ...
  charcoal: {
    ...
    colors: {
      ...
      borderSubtle: 'rgba(201, 167, 90, 0.1)',
      text: '#E8E8E8',
      textMuted: 'rgba(232, 232, 232, 0.7)',
      accent: '#D4B56A',
      accentHover: '#E5C87A',
  ...
  forest: {
    ...
    colors: {
      ...
      borderSubtle: 'rgba(201, 167, 90, 0.1)',
      text: '#E8F0EB',
      textMuted: 'rgba(232, 240, 235, 0.7)',
      accent: '#C9A75A',
      accentHover: '#DABB6A',
      accentMuted: 'rgba(201, 167, 90, 0.25)',
      inputBg: '#152A20',
  ...
  plum: {
    ...
    colors: {
      ...
      borderSubtle: 'rgba(201, 167, 90, 0.1)',
      text: '#F0E8F4',
      textMuted: 'rgba(240, 232, 244, 0.7)',
      accent: '#D4B56A',
      accentHover: '#E5C87A',
      accentMuted: 'rgba(212, 181, 106, 0.25)',
      inputBg: '#2A1A32',
  ...
  coffee: {
    ...
    colors: {
      ...
      borderSubtle: 'rgba(201, 167, 90, 0.1)',
      text: '#F4EDE6',
      textMuted: 'rgba(244, 237, 230, 0.7)',
      accent: '#D4A860',
      accentHover: '#E5BB70',
  ...
  ocean: {
    ...
    colors: {
      ...
      borderSubtle: 'rgba(201, 167, 90, 0.1)',
      text: '#E6F0F8',
      textMuted: 'rgba(230, 240, 248, 0.7)',
      accent: '#D4B56A',
      accentHover: '#E5C87A',
      accentMuted: 'rgba(212, 181, 106, 0.25)',
      inputBg: '#122535',
